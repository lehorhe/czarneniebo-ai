...
def demucs_separuj(
    ...
    folder_wyjsciowy: str | pathlib.Path = "C:/Users/rzecz/AI-Dziennikarstwo/wyniki/separated",
    model: str = "htdemucs",
...
def real_esrgan_upscale(
    ...
    skala: int = 4,
    folder_wyjsciowy: str | pathlib.Path = "C:/Users/rzecz/AI-Dziennikarstwo/wyniki",
) -> str:
    """
